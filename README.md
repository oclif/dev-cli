...
@oclif/dev-cli/0.3.11 (linux-x64) node-v9.5.0
...
_See code: [@oclif/dev-cli](https://github.com/oclif/dev-cli/blob/v0.3.11/src/commands/manifest.ts)_
...
_See code: [@oclif/dev-cli](https://github.com/oclif/dev-cli/blob/v0.3.11/src/commands/readme.ts)_
<!-- commandsstop -->
