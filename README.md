...
@oclif/dev-cli/1.9.8 linux-x64 node-v9.11.1
...
_See code: [src/commands/manifest.ts](https://github.com/oclif/dev-cli/blob/v1.9.8/src/commands/manifest.ts)_
...
_See code: [src/commands/pack.ts](https://github.com/oclif/dev-cli/blob/v1.9.8/src/commands/pack.ts)_
...
_See code: [src/commands/publish.ts](https://github.com/oclif/dev-cli/blob/v1.9.8/src/commands/publish.ts)_
...
_See code: [src/commands/readme.ts](https://github.com/oclif/dev-cli/blob/v1.9.8/src/commands/readme.ts)_
<!-- commandsstop -->
