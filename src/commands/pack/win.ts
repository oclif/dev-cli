...
export default class PackWin extends Command {
  ...
  static flags = {
    ...
    input: flags.string({ char: 'i', description: 'optionally specify a path to a tarball already generated by NPM', required: false })
  }
  ...
  async run() {
    ...
    await Tarballs.build(buildConfig, {platform: 'win32', pack: false, input: flags.input})
